...
#      elements in common?
    def intersect(self, others):
        ...
        if len(resultset)!= 0:
            ...
            return "No common elements in both the sets"
...
def main():
    ...
    print("number of elements in setA : ", len(setA))
    print("number of elements in setB : ",len(setB))
    print("number of elements in common set : ", len(setA.intersect(setB)))
